					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								<a href="https://www.facebook.com/AbdurRahimApurbo" class="fa fa-facebook"></a>
					...
					<div class="col-md-12">
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								<img src="img/apurbo.jpg" class="img-responsive">
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Freelancer Apurbo</h4>
									<h4 class="team-member-designation">PHP Framework</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/AbdurRahimApurbo" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Freelancer Apurbo</h4>
									<h4 class="team-member-designation">Web Developer $ CMS</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/AbdurRahimApurbo" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
										<li><a href="www.teitter.com" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
										<li><a href="" class="social-icon icon-gray"><i class="fa fa-google-plus"></i></a></li>
									</ul>
								</div>
							</div>
							...
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Freelancer Apurbo</h4>
									<h4 class="team-member-designation">Java Developer</h4>
									<ul class="social-list">
										<li><a href="https://www.facebook.com/AbdurRahimApurbo" class="social-icon icon-gray"><i class="fa fa-facebook"></i></a></li>
